...
public class ProfiliImMenaxher extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            for (int i = 0; i < lista.size(); i++) {
                if (lista.get(i).getUIdlog().equals(user_id)) {
                    JOptionPane.showMessageDialog(this, "ICDS: Kjo llogari është e regjistruar në kompani.");
                    return true;
                }
            }
    ...
    private void initComponents() {
        ...
        gjiniaComboProfile = new javax.swing.JComboBox<>();
        ...
        MyProfileMenaxheriBackground.setBackground(new java.awt.Color(153, 153, 255));

        MyProfileMenaxheriUpperBackground.setBackground(new java.awt.Color(124, 124, 255));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/images/myp_vectorized.png"))); // NOI18N
        ...
        MyProfileMenaxheriUpperBackgroundLayout.setVerticalGroup(
            MyProfileMenaxheriUpperBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, MyProfileMenaxheriUpperBackgroundLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jLabel1)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        TeDhenatEPunetoritJlabel.setFont(new java.awt.Font("SansSerif", 2, 14)); // NOI18N
        TeDhenatEPunetoritJlabel.setForeground(new java.awt.Color(0, 0, 0));
        TeDhenatEPunetoritJlabel.setText("Të dhënat e punëtorit:");

        teDhenatPerKyqjeJlabel.setFont(new java.awt.Font("SansSerif", 2, 14)); // NOI18N
        teDhenatPerKyqjeJlabel.setForeground(new java.awt.Color(0, 0, 0));
        ...
        emriTextField.setForeground(new java.awt.Color(0, 0, 0));
        ...
        MbiemriTextField.setForeground(new java.awt.Color(0, 0, 0));
        ...
        MoshaTextField.setForeground(new java.awt.Color(0, 0, 0));
        ...
        AdresaTextField.setForeground(new java.awt.Color(0, 0, 0));
        ...
        idJlabel.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        idJlabel.setForeground(new java.awt.Color(0, 0, 0));
        idJlabel.setText("id:");

        emriJlabel.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        emriJlabel.setForeground(new java.awt.Color(0, 0, 0));
        emriJlabel.setText("emri:");

        mbiemriJlabel.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        mbiemriJlabel.setForeground(new java.awt.Color(0, 0, 0));
        mbiemriJlabel.setText("mbiemri:");

        moshaJlabel.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        moshaJlabel.setForeground(new java.awt.Color(0, 0, 0));
        moshaJlabel.setText("mosha:");

        adresaJlabel.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        adresaJlabel.setForeground(new java.awt.Color(0, 0, 0));
        adresaJlabel.setText("adresa:");

        gjiniaJlabel.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        gjiniaJlabel.setForeground(new java.awt.Color(0, 0, 0));
        gjiniaJlabel.setText("gjinia:");

        usernameField.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        usernameField.setHorizontalAlignment(javax.swing.JTextField.CENTER);

        usernameJlabel.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        usernameJlabel.setForeground(new java.awt.Color(0, 0, 0));
        usernameJlabel.setText("username:");

        passwordJlabel.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        ...
        usernameJlabel1.setFont(new java.awt.Font("SansSerif", 0, 13)); // NOI18N
        usernameJlabel1.setForeground(new java.awt.Color(0, 0, 0));
                ...
                .addGroup(MyProfileMenaxheriBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(MyProfileMenaxheriBackgroundLayout.createSequentialGroup()
                        ...
                        .addGroup(MyProfileMenaxheriBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(idField, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        MyProfileMenaxheriBackgroundLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {idField, jPasswordField, usernameField});
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(MyProfileMenaxheriBackground, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0))
        );
    ...
    private void RuajBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RuajBtnActionPerformed
        try {
            ...
            try {
                Integer mosha = Integer.parseInt(MoshaTextField.getText().replaceAll("\\s", ""));
                Object[] ob = {"Po", "Jo"};
                int result = JOptionPane.showOptionDialog(this, "ICDS: A jeni i sigurtë qe dëshironi të ndryshoni të dhenat e juaja personale?"
    ...
    private void RuajBtn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RuajBtn2ActionPerformed
        try {
            ...
            if (kaVetemShkronja(idUserit)) {
                ...
                JOptionPane.showMessageDialog(this, "ICDS: Keni shtypur karakter te pa lejueshem ne hapsiren për username.");
                return;
            }
            Object[] ob = {"Po", "Jo"};
            int result = JOptionPane.showOptionDialog(this, "ICDS: A jeni i sigurtë qe dëshironi të ndryshoni të dhenat për kyqje?"
