...
public class UsersInternalForm extends javax.swing.JInternalFrame {
    ...
    private void ruaj_LlogarineBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ruaj_LlogarineBtnActionPerformed
        if (!user_id_field.getText().trim().equals("")
            ...
            JOptionPane.showMessageDialog(this, "ICDS: Te gjitha fushat jane obligative ti plotesoni per ta regjistruar llogarine e re!");
        }
    }//GEN-LAST:event_ruaj_LlogarineBtnActionPerformed
